...
int main(void) {
    ...
    //fflush(stdin); 
    fgets(aluno.nome, 50,stdin);  //Desta maneira conseguimos inserir espacos no nome
    //scanf("%s%*c", &aluno.nome); Dest forma so conseguimos inserir um nome continuo sem espacos
